...
import com.example.gospace_ipt.databinding.ActivityGsoViewPageBinding
...
class GSOViewPage : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityGsoViewPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGsoViewPageBinding.inflate(layoutInflater)
        ...
        viewPager.adapter = GSOFragmentAdapter(this)
